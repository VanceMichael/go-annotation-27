...
- 项目：VanceMichael/go-annotation-27
...
1. 预期退出码 0：`go test ./internal/review/ ./internal/cli/ -run "TestRateLimitedIsRetryable|TestSubmitRetriesOnRateLimit|TestChannelErrorExposesUnderlyingCause|TestSubmitRetriesUpToMaxAttempts|TestReviewSubmitRetriesOnThrottle" -count=1`
